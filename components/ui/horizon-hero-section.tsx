    ...
    <div ref={containerRef} className="hero-container cosmos-style relative min-h-screen bg-[#0F172A] overflow-hidden">
      ...
      <div className="scroll-sections relative z-10">
       {[...Array(2)].map((_, i) => {
          ...
          return (
            <section key={i} className="content-section min-h-screen flex flex-col items-center justify-center pointer-events-none">
              <h1 className="hero-title text-8xl md:text-[12rem] font-bold text-white tracking-tighter">
                {titles[i+1] || 'DEFAULT'}
              </h1>
